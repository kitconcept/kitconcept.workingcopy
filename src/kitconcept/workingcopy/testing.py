...
WORKINGCOPY_CORE_INTEGRATION_TESTING = IntegrationTesting(
    bases=(WORKINGCOPY_CORE_FIXTURE,), name="WorkingcopyCoreLayer:IntegrationTesting"
)
...
WORKINGCOPY_CORE_ACCEPTANCE_TESTING = FunctionalTesting(
    bases=(WORKINGCOPY_CORE_FIXTURE, REMOTE_LIBRARY_BUNDLE_FIXTURE, z2.ZSERVER_FIXTURE),
